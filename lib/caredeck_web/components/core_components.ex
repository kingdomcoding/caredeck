defmodule CaredeckWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(CaredeckWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(CaredeckWeb.Gettext, "errors", msg, opts)
    # end
